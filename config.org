...
(custom-set-faces! '(delete-selection-mode t) ;; delete when you select region and modify
...
#+begin_src emacs-lisp
(after! doom-modeline
  (custom-set-faces! '(doom-modeline-buffer-file-name-style 'relative-to-project)
...
#+begin_src emacs-lisp
(custom-set-faces! '(company-show-numbers t))
#+end_src
...
(after! tree-sitter
  ...
  (add-hook! 'tree-sitter-after-on-hook #'tree-sitter-hi-mode)
...
(after! org-fancy-priorities
  (custom-set-faces! '(org-lowest-priority ?E))
...
(custom-set-faces! '(LaTeX-section-label '(("part" . "part:")
                                           ("chapter" . "chap:")
                                           ("section" . "sec:")
                                           ("subsection" . "subsec:")
